                ...
                <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-4">
                        ...
                        <p className="text-sm text-neutral-500 leading-relaxed">
                            We require all partner factories to adhere to the ILO (International Labour Organization) core conventions. This includes zero tolerance for forced labor, child labor, and unsafe working conditions. We conduct unannounced audits biannually.
                        </p>
                    </div>
                    <div className="space-y-4">

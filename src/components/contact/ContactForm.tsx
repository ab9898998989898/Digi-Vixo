    ...
    return (
        <div className="flex flex-col items-start justify-center h-full space-y-8 min-h-[400px]">
            ...
            <a
                ...
                className="w-full bg-black dark:bg-white text-white dark:text-black py-4 px-8 rounded-full font-bold uppercase tracking-widest hover:opacity-80 transition-opacity flex items-center justify-center gap-3 group"
            >
